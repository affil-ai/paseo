  ...
  workspace: {
    ...
    tabs: {
      ...
      actions: {
        ...
        closedChatsMenu: "Conversas fechadas",
      ...
      explorer: {
        ...
        copyPrLink: "Copiar link do pull request #{{number}}",
        copyPrLinkLabel: "Link do PR",
        copyPrLinkFailed: "Não foi possível copiar o link do PR",
      },
      toasts: {
  ...
  sidebar: {
    ...
    workspace: {
      ...
      toasts: {
        ...
        hostDisconnected: "Host não está conectado",
        chatRepositorySet: "Chat repo set",
        chatRepositoryUnset: "Chat repo unset",
        chatRepositoryFailed: "Failed to update chat repo",
