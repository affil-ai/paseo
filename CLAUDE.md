...
| [docs/chat-bridge.md](docs/chat-bridge.md)                     | Chat bridge (v1→v2 roadmap): driving agents from Slack/Chat SDK as another daemon client; v1 inbound + focus relay, v2 agent-initiated chat                     |
| [docs/office-brain.md](docs/office-brain.md)                   | Office Brain scoping: compounding OKF/markdown agent memory for the CTO-office agent — capture/query/lint, `/code/office`, skills hosting (not yet implemented) |
